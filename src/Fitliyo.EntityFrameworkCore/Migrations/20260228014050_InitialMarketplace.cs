        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialtyTags = table.Column<string>(type: "text", nullable: true),
                    ...
                    TotalStudentCount = table.Column<int>(type: "integer", nullable: false),
                    IsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    VerificationBadge = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrainerProfiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AppPackageUnavailableDates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPackageUnavailableDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPackageUnavailableDates_AppTrainerProfiles_TrainerProfil~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatIsIncluded = table.Column<string>(type: "text", nullable: true),
                    WhatIsNotIncluded = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppServicePackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppServicePackages_AppTrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "AppTrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AppTrainerCategoryMappings",
                columns: table => new
                {
                    TrainerProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrainerCategoryMappings", x => new { x.TrainerProfileId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_AppTrainerCategoryMappings_AppCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "AppCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTrainerCategoryMappings_AppTrainerProfiles_TrainerProfil~",
                        column: x => x.TrainerProfileId,
                        principalTable: "AppTrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AppTrainerCertificates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TrainerProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    CertificateName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    IssuingOrganization = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    IssueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExpiryDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DocumentUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    IsVerifiedByPlatform = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrainerCertificates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTrainerCertificates_AppTrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "AppTrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrainerGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTrainerGalleries_AppTrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "AppTrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AppPackageAvailabilitySchedules",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPackageAvailabilitySchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPackageAvailabilitySchedules_AppServicePackages_ServiceP~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPackageAvailabilitySchedules_ServicePackageId",
                table: "AppPackageAvailabilitySchedules",
                column: "ServicePackageId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPackageUnavailableDates_TrainerProfileId",
                table: "AppPackageUnavailableDates",
                column: "TrainerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPackageUnavailableDates_TrainerProfileId_UnavailableDate",
                table: "AppPackageUnavailableDates",
                columns: new[] { "TrainerProfileId", "UnavailableDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppServicePackages_IsActive",
                table: "AppServicePackages",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppServicePackages_PackageType",
                table: "AppServicePackages",
                column: "PackageType");

            migrationBuilder.CreateIndex(
                name: "IX_AppServicePackages_TrainerProfileId",
                table: "AppServicePackages",
                column: "TrainerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerCategoryMappings_CategoryId",
                table: "AppTrainerCategoryMappings",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerCertificates_TrainerProfileId",
                table: "AppTrainerCertificates",
                column: "TrainerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerGalleries_TrainerProfileId",
                table: "AppTrainerGalleries",
                column: "TrainerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerProfiles_City",
                table: "AppTrainerProfiles",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerProfiles_IsActive",
                table: "AppTrainerProfiles",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerProfiles_Slug",
                table: "AppTrainerProfiles",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerProfiles_TrainerType",
                table: "AppTrainerProfiles",
                column: "TrainerType");

            migrationBuilder.CreateIndex(
                name: "IX_AppTrainerProfiles_UserId",
                table: "AppTrainerProfiles",
                column: "UserId",
                unique: true);
